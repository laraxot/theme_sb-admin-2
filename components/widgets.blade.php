<section class="widget-group ui-sortable">
    <div id="messages-widget" class="proton-widget messages lit">
        ...
        <div class="panel panel-success front">
            ...
            <div>
                <ul class="list-group pending">
                    <li class="list-group-item">
                        <i><img src="{{asset('theme/images/user-icons/user1.jpg')}}" alt="User Icon"></i>
                    ...
                    <li class="list-group-item">
                        <i><img src="{{asset('theme/images/user-icons/user5.jpg')}}" alt="User Icon"></i>
                        <div class="text-holder">
                            <span class="title-text">
                                Prasent Neque:
                            </span>
                    ...
                    <li class="list-group-item">
                        <i><img src="{{asset('theme/images/user-icons/user10.jpg')}}" alt="User Icon"></i>
                        <div class="text-holder">
                            <span class="title-text">
                                Nunc Cenenatis:
                            </span>
                    ...
                    <li class="list-group-item">
                        <i><img src="{{asset('theme/images/user-icons/user3.jpg')}}" alt="User Icon"></i>
                        <div class="text-holder">
                            <span class="title-text">
                                Morbi Demoa:
                            </span>
    ...
    <div id="general-stats-widget" class="proton-widget general-stats lit">
        <div class="panel panel-default back">
            <div class="panel-heading">
                <i class="icon-cog"></i>
                <span>Settings</span>
    ...
    <div id="latest-users-widget" class="proton-widget latest-users lit">
        <div class="panel panel-default back">
            <div class="panel-heading">
                <i class="icon-cog"></i>
                <span>Settings</span>
        ...
        <div class="panel panel-info front">
            ...
            <div>
                <ul class="list-group pending">
                    ...
                    <li class="list-group-item">
                        <i><img src="{{asset('theme/images/user-icons/user2.jpg')}}" alt="User Icon"></i>
                        <div class="text-holder">
                            <span class="title-text">
                                Nunc Cenenatis
                            </span>
                    ...
                    <li class="list-group-item">
                        <i><img src="{{asset('theme/images/user-icons/user4.jpg')}}" alt="User Icon"></i>
                        <div class="text-holder">
                            <span class="title-text">
                                Morbi Demoa
                            </span>
                    ...
                    <li class="list-group-item">
                        <i><img src="{{asset('theme/images/user-icons/user8.jpg')}}" alt="User Icon"></i>
                        <div class="text-holder">
                            <span class="title-text">
                                Sel Drvenar
                            </span>
    ...
    <div id="task-completion-widget" class="proton-widget task-completion lit">
        <div class="panel panel-default back">
            <div class="panel-heading">
                <i class="icon-cog"></i>
                <span>Settings</span>
    ...
    <div id="sales-income-widget" class="proton-widget lit">
        <div class="panel panel-default back">
            <div class="panel-heading">
                <i class="icon-cog"></i>
                <span>Settings</span>
    ...
    <div id="expenses-widget" class="proton-widget lit">
        <div class="panel panel-default back">
            <div class="panel-heading">
                <i class="icon-cog"></i>
                <span>Settings</span>
